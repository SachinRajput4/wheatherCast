    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in p-4">
      ...
      {data.aiEnhancements && (
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 shadow-lg">
          ...
          {/* AI Enhanced Recommendations */}
          {data.aiEnhancements.ai_enhanced_recommendations && data.aiEnhancements.ai_enhanced_recommendations.length > 0 && (
            <div className="mb-6">
              ...
              <ul className="space-y-3">
                {data.aiEnhancements.ai_enhanced_recommendations.map((rec, index) => (
                  <li key={index} className="flex items-start bg-white rounded-lg p-3 shadow-sm border border-purple-100">
          ...
          {/* Creative Solutions */}
          {data.aiEnhancements.creative_solutions && data.aiEnhancements.creative_solutions.length > 0 && (
            <div className="mb-6">
              <h5 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
                <span className="mr-2">💡</span>
                Creative Solutions
              ...
              <ul className="space-y-3">
                {data.aiEnhancements.creative_solutions.map((solution, index) => (
                  <li key={index} className="flex items-start bg-white rounded-lg p-3 shadow-sm border border-blue-100">
          ...
          {data.aiEnhancements.budget_optimization_tips && data.aiEnhancements.budget_optimization_tips.length > 0 && (
            <div className="mb-6">
              <h5 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
                <span className="mr-2">💰</span>
                Budget Optimization
              ...
              <ul className="space-y-3">
                {data.aiEnhancements.budget_optimization_tips.map((tip, index) => (
                  <li key={index} className="flex items-start bg-white rounded-lg p-3 shadow-sm border border-green-100">
          ...
          {/* Vendor Coordination */}
          {data.aiEnhancements.vendor_coordination_advice && data.aiEnhancements.vendor_coordination_advice.length > 0 && (
            <div>
              <h5 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
                <span className="mr-2">🤝</span>
                Vendor Coordination
              ...
              <ul className="space-y-3">
                {data.aiEnhancements.vendor_coordination_advice.map((advice, index) => (
                  <li key={index} className="flex items-start bg-white rounded-lg p-3 shadow-sm border border-yellow-100">
                    <span className="flex-shrink-0 w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center text-white text-xs mt-0.5 mr-3">
                      🤝
                    </span>
                    <span className="text-gray-700">{advice}</span>
